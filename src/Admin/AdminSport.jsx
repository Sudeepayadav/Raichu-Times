        ...
        <div className="w-3/5">
          <div className="flex">
            <div className="w-4/5 p-5 border-r border-gray-600 border-b">
              ...
              <p>
                {" "}
                ಟೀಮ್ ಇಂಡಿಯಾ ಮಾಜಿ ಆಲ್‌ರೌಂಡರ್‌ ಯುವರಾಜ್‌ ಸಿಂಗ್‌ ಸಾರ್ವಕಾಲಿಕ ಶ್ರೇಷ್ಠ
                ಪ್ಲೇಯಿಂಗ್ 11 ರಚನೆ ಮಾಡಿದ್ದಾರೆ. ಯುವರಾಜ್‌ ಸಿಂಗ್‌ ಸಾರಥ್ಯದಲ್ಲಿ ಇಂಡಿಯಾ
                ಲೆಜೆಂಡ್ಸ್‌ ತಂಡ ಇತ್ತೀಚೆಗೆ ಅಂತ್ಯಗೊಂಡ ಲೆಜೆಂಡ್ಸ್‌ ವರ್ಡ್‌
