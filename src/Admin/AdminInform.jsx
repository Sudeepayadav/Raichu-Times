...
function AdminInform() {
  return (
    <div className="flex mt-10">
      ...
      <div className="md:flex md:w-full md:m-auto">
        <div className="md:w-9/12 w-screen md:ml-0 md:flex m-auto pl-5 pr-5">
          <div className="text-xs space-y-6">
            ...
            <div className="space-y-3">
              ...
              <h1 className="font-semibold text-black">
                ಭಾನುವಾರದ ದಿನ ನಾಲ್ವರು ವಿದ್ಯಾರ್ಥಿಗಳು ಹೊಸಕೋಟೆ ಬಿರಿಯಾನಿ ತಿನ್ನಲು
                ಬೆಳಗ್ಗಿನ ಮೂರು ಗಂಟೆಗೆ ಹೋಗಿ ವಾಪಾಸು ಬರುವಾಗ ಕಾರಿನ ಹಿಂಬದಿಗೆ ಬೇರೊಂದು
                ವಾಹನ ಗುದ್ದಿ, ಕಾರು ಡಿವೈಡರ್‌ಗೆ ಡಿಕ್ಕಿಯಾದ ಪರಿಣಾಮ ಇಬ್ಬರು
                ಮೃತಪಟ್ಟಿದ್ದಾರೆ. ಕಾರಿನಲ್ಲಿ ಬಿರಿಯಾನಿ ಪೊಟ್ಟಣಗಳಿದ್ದು, ಹೊಸಕೋಟೆಗೆ ಹೋಗಿ
        ...
        <div className="mr-2">
          <div className="w-[350px] bg-black h-fit text-white">
            ...
            <p className="text-center text-lg p-2 mb-5">
            ...
            <div className="text-center bg-blue-200 flex">
              <div className="p-4 ml-3">
                ...
                />
                <button className="bg-red-500 p-1.5 ml-2 rounded-lg">
                  Signup
                </button>
              </div>
            </div>
