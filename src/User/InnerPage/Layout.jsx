...
const Layout = () => {
  return (
    <div className=" flex  ">
      ...
      <div className=" w-52 ml-14 flex  ">
        <div className=" flex flex-col">
          <AdPage
            imgSrc="https://m.media-amazon.com/images/I/71657TiFeHL._AC_UY327_FMwebp_QL65_.jpg"
            linkToAd="https://redtape.com/"
          />
          <AdPage
            imgSrc="https://m.media-amazon.com/images/I/71GLMJ7TQiL._AC_UY327_FMwebp_QL65_.jpg"
